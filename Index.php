...
<head>
 ...
 <div class="container  shadow p-3 mb-5 bg-white rounded" style="width: 60%; background: white;">
     ...
     <div class="row text-uppercase"><div style="background-color: #846125;"><h5 style="margin-left: 45px; color: white;margin-top: 7px;">NOS GUSTARíA CONOCER</h5></div><img style="height: 40px;" src="image/parte.png"></div>
         ...
         <div class="container-fluid" style="padding-top: 20px;">
             ...
             <div style=" {{(error_necesidades?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                 ...
                 <textarea  id="necesidades" name="necesidades" rows="3" ng-change="error_necesidades = (formData.necesidades?'':'Complete este campo')" ng-model="formData.necesidades"  placeholder="Tu respuesta" required data-toggle="tooltip" data-placement="right" title="Cuéntenos que espera obtener con nuestro curso">
                 </textarea>
             ...
             <div class="form-group">
                 ...
                 <select id="facturacion" name="facturacion" ng-model="formData.facturacion" ng-change="onFacturacion()">
                     ...
                     <div id="isFacturacion" ng-show="formData.facturacion == 'SI'" style="margin-left: 5px;margin-right: 5px; border-top: rgba(126,72,8,0.62) 1px solid;border-bottom: rgba(126,72,8,0.62) 1px solid; margin-top: 5px;" class="container-fluid">
                             ...
                             <div class="form-group" style="margin-top: 20px; {{(error_otro_domicilio?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                                 ...
                                 <a href="" class="float-right" ng-click="otroDomicilio(false);error_otro_domicilio='';" ng-show="od == true"><small>Cancelar</small></a>
                             ...
                             <div class="form-group" style="{{(error_rfc_facturario?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                                 ...
                                 <a href="" class="float-right" ng-click="otroRFC(false);error_rfc_facturario=''" ng-show="orfc == true"><small>Cancelar</small></a>

                                 <label class="label_show" ng-show="orfc != true">{{(datosCliente.RFC_FACTURARIO? datosCliente.RFC_FACTURARIO:datosCliente.RFC)}}</label>
                                 <input type="text" ng-show="orfc == true" id="rfc_facturario" name="rfc_facturario" ng-change="error_rfc_facturario = (formData.rfc_facturario?'':'Complete este campo')" ng-model="formData.rfc_facturario" placeholder="Tu respuesta" required data-toggle="tooltip" data-placement="right" title="Escriba otro RFC" ng-init="formData.rfc_facturario = (datosCliente.RFC_FACTURARIO? datosCliente.RFC_FACTURARIO:datosCliente.RFC)">
                                 <small class="text-danger">{{(error_rfc_facturario)}}</small>
                             </div>
                             <div class="form-group" style="{{((error_otro_contacto_nombre||error_otro_contacto_telefono||error_otro_contacto_email)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                                 ...
                                 <a href="" class="float-right" ng-click="otroContacto(false);error_otro_contacto_nombre='';error_otro_contacto_telefono='';error_otro_contacto_email=''" ng-show="oc == true"><small>Cancelar</small></a>
             ...
             <div class="form-group" style="{{(error_razon_viaRadio?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                 ...
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio1" name="viaRadio" ng-model="formData.medio" value="He tomado cursos antes con IMNC"  class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio1">He tomado cursos antes con IMNC</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio2" name="viaRadio" ng-model="formData.medio" value="Cliente de Certificación" class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio2">Cliente de "Certificación"</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio3" name="viaRadio" ng-model="formData.medio" value="Cliente de Venta de Normas" class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio3">Cliente de "Venta de Normas"</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio4" name="viaRadio" ng-model="formData.medio" value="Página web" class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio4">Página web</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio5" name="viaRadio" ng-model="formData.medio" value="Redes Sociales" class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio5">Redes Sociales</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio6" name="viaRadio" ng-model="formData.medio" value="Recomendación de una empresa/cliente" class="custom-control-input">
                     <label class="custom-control-label" for="viaRadio6">Recomendación de una empresa/cliente</label>
                 </div>
                 <div class="custom-control custom-radio">
                     <input type="radio" id="viaRadio7" name="viaRadio" ng-model="formData.medio" value="Recomendación de consultor/instructor" class="custom-control-input">
             ...
             <div class="form-group" style="{{((error_sede)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                 ...
                 <a href="" class="float-right" ng-click="otraSede(false);error_sede;" ng-show="sede == true"><small>Cancelar</small></a>
                 <label class="label_show" ng-show="sede != true">{{(datosCurso.SEDE)}}</label>
                 <input type="text" ng-show="sede == true" id="sede_curso" name="sede_curso"  ng-change="error_sede = (formData.sede_curso?'':'Complete este campo')" ng-model="formData.sede_curso" placeholder="Tu respuesta" data-toggle="tooltip" data-placement="right" title="{{(sede == true?'Escriba otra Sede':'')}}" required    ng-init="formData.sede_curso = datosCurso.SEDE" >
              ...
              <div class="form-group" style="{{((error_horario)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                     ...
                     <div class="form-inline" style="border-bottom: rgba(126,72,8,0.62) 1px solid; width: 40%;">
                         <select class="text-center" id="hora_inicio" name="hora_inicio" ng-model="formData.hora_inicio" ng-change="error_horario = (formData.hora_inicio?'':'Complete este campo')" >
                 ...
                 <div class="form-group"  style="{{((error_medidas_proteccion)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                     ...
                     <input ng-show="formData.select_medidas_proteccion=='SI'" type="text" id="medidas_proteccion" name="medidas_proteccion" ng-change="error_medidas_proteccion = (formData.medidas_proteccion?'':'Complete este campo')" ng-model="formData.medidas_proteccion" placeholder="Tu respuesta" data-toggle="tooltip" data-placement="right" title="Indicar si el auditor necesita algún tipo de medidas de protección (cascos, zapatos o ropa especiales) para brindar el servicio" required >
             ...
             <div id="programado" ng-show="modalidad == 'programado'">
                 <div class="form-group"  style="{{((error_estado_visita)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
                     ...
                     <select ng-model="formData.estado_visita" ng-options="estado.ENTIDAD_FEDERATIVA as estado.ENTIDAD_FEDERATIVA for estado in estados"
                              id="estado_visita" name="estado_visita" ng-change="error_estado_visita = (formData.estado_visita?'':'Complete este campo')" required >
     ...
     <div class="container-fluid" style="padding-top: 20px; ">
         <table class="table " ng-show="cantidad_insertados>0">
             ...
             <tbody  ng-repeat="(key, item) in participantes" >
                  ...
                  <td>{{item.CURP}}</td>
                  <td>{{item.PERFIL}}</td>
                  <td><button class="btn btn-secondary btn-sm" ng-click="showEditParticipantes(key);"><i class="fa fa-pencil"></i>Editar</button></td>
             </tbody>
             <tbody><td></td></tbody>
         </table>

         <a href=""  ng-click="showFormP()" ng-show="show_p == false && cantidad_insertados>0 && cantidad_insertados < total && (datosCurso.NOMBRE_ETAPA == 'INSCRITO' || datosCurso.NOMBRE_ETAPA == 'PROGRAMADO')"><small>+ Agregar Participante</small></a>
         <div ng-show="datosCurso.NOMBRE_ETAPA != 'INSCRITO' && datosCurso.NOMBRE_ETAPA != 'PROGRAMADO'"><h5>Ya no se puede gestionar los participante porque el curso esta en la etapa: {{datosCurso.NOMBRE_ETAPA}}</h5></div>
         <div id="formParticipantes"  ng-show="(show_p == true  || cantidad_insertados==0) && (datosCurso.NOMBRE_ETAPA == 'INSCRITO' || datosCurso.NOMBRE_ETAPA == 'PROGRAMADO') " ng-if="cantidad_insertados < total" style="{{((mensaje)?'background-color: rgba(255,9,19,0.16);border-radius: 5px;padding: 5px; ':'')}}">
         <form novalidate>
     ...
     <div class="form-group" style="margin-top: 40px; border-top: rgba(126,72,8,0.62) 1px solid"  >
         <button class="btn btn-primary" ng-click="submitForm()" data-toggle="tooltip" data-placement="right" style="margin-top: 20px;" title="Al hacer click aquí para enviar todos los datos introducidos al formulario">Enviar al IMNC </button>
         <div class="d-flex align-items-center hide" ng-show="enviar">
